# Generated by Django 4.0.1 on 2022-01-29 18:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Requierd and unique', max_length=255, unique=True, verbose_name='Category Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('decimal_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'the price must be between 0 and 999.99.'}}, help_text='Maximum 999.99', max_digits=5, verbose_name='Decimal price')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Required', max_length=225, verbose_name='Name')),
            ],
            options={
                'verbose_name': 'Product Specification',
                'verbose_name_plural': 'Product Spesifications',
            },
        ),
        migrations.CreateModel(
            name='ProductType',
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'specification_Value',
                'verbose_name_plural': 'specification_Values',
            },
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(default='images/default.png', help_text='uploade a product image', upload_to='images/', verbose_name='image')),
                ('alt_text', models.CharField(blank=True, help_text='lease add alternative text', max_length=255, null=True, verbose_name='Alturnative text')),
